...
@commands.has_any_role('Staff', '$', 'BOSS OF THE GYM', 'Администратор')
@bot.slash_command(name="clear", description='Очистка чата в определённом количестве')
